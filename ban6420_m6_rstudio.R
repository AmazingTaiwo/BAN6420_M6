...
cat("Shape of training data before reshaping:", dim(x_train), "\n")
cat("Shape of test data before reshaping:", dim(x_test), "\n")
...
history <- model %>% fit(
  ...
  validation_data = list(x_test, y_test),              # Validation data
...
cat("Test loss:", test_result[1], "\n")
cat("Test accuracy:", test_result[2], "\n")
